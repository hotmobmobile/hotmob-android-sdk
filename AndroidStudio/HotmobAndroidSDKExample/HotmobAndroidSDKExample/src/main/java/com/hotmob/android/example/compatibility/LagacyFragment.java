 ...
 */
public class LagacyFragment extends BaseFragment {
    ...
    public static LagacyFragment newInstance(int activityCounter, int fragmentCounter) {
        Bundle args = new Bundle();

        LagacyFragment fragment = new LagacyFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.i(LOG_TAG, "onCreateView() - "+fragmentCounter);
        View root = inflater.inflate(R.layout.fragment_lagacy, container, false);
    ...
    public void callBanner() {
        if (bannerView == null) {
            Log.d(LOG_TAG, "start creating banner");

            // TODO: Call Banner
            final HotmobManagerListener bannerListener = new HotmobManagerListener() {
                @Override
                public void didLoadBanner(View bannerView) {
                    Log.d(LOG_TAG, "didLoadBanner in Fragment " + fragmentCounter + " in Activity " + activityCounter);
                ...
                public void willHideBanner(View bannerView) {
                    ...
                    Log.d(LOG_TAG, "willHideBanner in Fragment " + fragmentCounter + " in Activity " + activityCounter);
                }

                @Override
                public void didHideBanner(View bannerView) {
                    super.didHideBanner(bannerView);
                    Log.d(LOG_TAG, "didHideBanner in Fragment " + fragmentCounter + " in Activity " + activityCounter);
                }
            };
