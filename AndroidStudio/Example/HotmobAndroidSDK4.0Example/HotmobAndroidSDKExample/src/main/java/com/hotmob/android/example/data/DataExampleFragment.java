...
import com.hotmob.sdk.datacollection.HMDataSet;
...
public class DataExampleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HMDataCollection.captureEvent(getContext(), "test_event", dataMap);

        root.findViewById(R.id.click_action).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                HMDataCollection.captureEvent(getContext(), "test_event_action", "clicked");
            }
        });
        root.findViewById(R.id.click_action_null).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String xxx = null;
                HMDataCollection.captureEvent(getContext(), "null_event_action", xxx);
            }
        });
        ...
        timedBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (timedEvent == null) {
                    timedEvent = new HMDataSet();
                    timedEvent.add("key1", "value1");
                    timedBtn.setText(R.string.timed_event_end);
                }else{
                    HMDataCollection.captureEvent(getContext(), "test_timed_event", timedEvent);
                    timedEvent = null;
